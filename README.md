...
4. **Etapa 4 – Custos Fixos Operacionais**: organize custos fixos nas categorias Operacionais, Administrativas e de Vendas. Informe descrições e valores mensais para compor o custo fixo usado nas análises de ponto de equilíbrio e fluxo de caixa.【F:streamlit_app.py†L1481-L1527】
5. **Etapa 5 – Investimentos**: liste ativos imobilizados ou investimentos iniciais, informando descrição, valor e mês de aquisição (0 para desembolsos iniciais).【F:streamlit_app.py†L1530-L1568】
